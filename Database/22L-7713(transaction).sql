...
BEGIN
BEGIN TRANSACTION
INSERT [dbo].[Registration] ([Semester], [RollNumber], [CourseID], [Section],GPA) VALUES (N'Fall2016', N'1', 20, N'A', @g)
COMMIT TRANSACTION
END
...
BEGIN
BEGIN TRANSACTION
PRINT ' He can only enroll in subjects in which he can improve.';
